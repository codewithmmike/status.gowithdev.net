...
@section('content')
    <div class="kfb-section-container" id="ltd_kq_byleague'">
        ...
        <div class="kfb-table-livescore kfb-calc">
            <h2 class="kfb-table-header">LTĐ bóng đá hôm nay, ngày mai</h2>
            <!-- Search box -->
                ...
                <div class="kfb-match-football-item" id="ltd1">
                    ...
                    <div class="kfb-f-row kfb-match-detail kfb-hot kfb-just kfb-comming kfb-happenning" data-leagueid="1"
                        ...
                        <div class="kfb-row-match">
                            ...
                            <div class="kfb-right">
                                <a href="#" class="kfb-item-ktv" title="Nhận định Liverpool vs Arsenal (00h30 ngày 24/12): Vượt cửa ải Anfield">
                                    Nhận định
                                </a>
                            ...
                            <div class="kfb-columns-match">
                                <div class="kfb-row-teams">
                                    ...
                                    <div class="kfb-columns-number">
                                        <p onclick="getMatchinfo(152900)">
                                            <span class="kfb-soccer-scores">1 - 1</span>
                                        </p>
                                    </div>
                                    <div class="kfb-columns-club">
                                        <a class="kfb-name-club kfb-club-2 kfb-c-red" href="#"
                                            title="Arsenal"> Arsenal
                                ...
                                <div class="kfb-row-match-info">
                                    ...
                                    <p class="kfb-hiep-phu" title="Trận đấu đã hoãn">Hoãn</p>
                                </div>
                            </div>
                            <div class="kfb-columns-other">
                                <div class="kfb-flex-right">
                                    ...
                                    <div class="kfb-item-other-4">
                                        <a title="Xem thông tin chi tiết Liverpool vs Arsenal"
                    ...
                    <div class="kfb-f-row kfb-match-detail kfb-hot" data-leagueid="1"
                        ...
                        <div class="kfb-football-match">
                            ...
                            <div class="kfb-columns-match">
                                <div class="kfb-row-teams">
                                    <div class="kfb-columns-club">
                                        <a class="kfb-name-club kfb-club-1 kfb-c-red"
                                            href="/clubs/wolves-1458.html" title="Wolves"> Wolves <img
                                                class="kfb-logo-club lazyload" alt="Wolves"
                                    ...
                                    <div class="kfb-columns-number">
                                        <p onclick="getMatchinfo(152906)"><span class="kfb-soccer-scores">vs</span></p>
                                    </div>
                            ...
                            <div class="kfb-columns-other">
                                <div class="kfb-flex-right">
                                    ...
                                    <div class="kfb-item-other-3 f-tv kfb-m-hidden"><span title="Xem kênh">K+SPORT1</span></div>
                ...
                <div class="kfb-match-football-item" id="ltd3">
                        ...
                        <div class="kfb-football-match">
                            ...
                            <div class="kfb-columns-match">
                                <div class="kfb-row-teams">
                                    <div class="kfb-columns-club"><a class="kfb-name-club kfb-club-1 kfb-c-red"
                                            href="/clubs/inter-milan-1399.html" title="Inter"> Inter <img
                                    ...
                                    <div class="kfb-columns-number">
                                        <p onclick="getMatchinfo(165753)"><span class="kfb-soccer-scores">2 - 0</span></p>
                                    </div>
                                    <div class="kfb-columns-club"><a class="kfb-name-club kfb-club-2 kfb-c-red"
                                            href="/clubs/lecce-2444.html" title="Lecce"> Lecce <img
                            ...
                            <div class="kfb-columns-other">
                                <div class="kfb-flex-right">
                                    ...
                                    <div class="kfb-item-other-2 kfb-m-hidden"></div>
                                    <div class="kfb-item-other-3 f-tv kfb-m-hidden"><span title="Xem kênh">ON Sports+</span></div>
                    ...
                    <div class="kfb-f-row kfb-match-detail" data-leagueid="3"
                        ...
                        <div class="kfb-football-match">
                            ...
                            <div class="kfb-columns-match">
                                <div class="kfb-row-teams">
                                    <div class="kfb-columns-club"><a class="kfb-name-club kfb-club-1" href="/clubs/verona-2443.html"
                                            title="Verona"> Verona <img class="kfb-logo-club lazyload" alt="Verona"
                                    ...
                                    <div class="kfb-columns-club"><a class="kfb-name-club kfb-club-2" href="/clubs/cagliari-47.html"
                                            title="Cagliari"> Cagliari <img class="kfb-logo-club lazyload" alt="Cagliari"
                                ...
                                <div class="kfb-row-match-info"><span class="kfb-item-ktv"><span title="Tỷ số hiệp 1">H1:</span>
                                        0-0</span></div>
                            </div>
                            <div class="kfb-columns-other">
                                <div class="kfb-flex-right">
                        ...
                        <div class="kfb-football-match">
                            ...
                            <div class="kfb-columns-other">
                                <div class="kfb-flex-right">
                                    ...
                                    <div class="kfb-item-other-2 kfb-m-hidden"></div>
                                    <div class="kfb-item-other-3 f-tv kfb-m-hidden"><span title="Xem kênh">&nbsp;</span></div>
                                    <div class="kfb-item-other-4"><a title="Xem thông tin chi tiết Royal Antwerp vs Westerlo"
                                            rel="follow" class="btn-f-more"
                        ...
                        <div class="kfb-football-match">
                            ...
                            <div class="kfb-columns-match">
                                <div class="kfb-row-teams">
                                    ...
                                    <div class="kfb-columns-club"><a class="kfb-name-club kfb-club-2" href="/clubs/genk-80.html"
                                            title="Genk"> Genk <img class="kfb-logo-club lazyload" alt="Genk"
